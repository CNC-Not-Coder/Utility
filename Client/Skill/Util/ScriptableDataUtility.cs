...
namespace Client.SkillTrigger
{
    ...
    {
        public static Vector2 CalcVector2(CallData callData)
        {
        ...
        public static Vector3 CalcVector3(CallData callData)
        {
        ...
        public static Vector4 CalcVector4(CallData callData)
        {
        ...
        public static Quaternion CalcQuaternion(CallData callData)
        {
        ...
        public static Quaternion CalcEularRotation(CallData callData)
        {
