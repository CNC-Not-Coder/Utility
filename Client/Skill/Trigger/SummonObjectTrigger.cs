...
namespace Client.SkillTrigger.Skill.Trigger
{
    public class SummonObjectTrigger : AbstractSkillTriger
    {
        ...
        protected override void Load(CallData callData)
        {
            ...
            {
                m_LocalPostion = ScriptableDataUtility.CalcVector3(callData.GetParam(4) as CallData);
            }
            if (callData.GetParamNum() >= 6)
            {
                m_LocalRotate = ScriptableDataUtility.CalcVector3(callData.GetParam(5) as CallData);
            }
        }
        ...
        public override bool Execute(object sender, SkillInstance instance, long delta, long curSectionTime)
        {
            ...
            LogicSystem.NotifyGfxSummonNpc(obj, instance.SkillId, m_NpcTypeId, m_ModelPrefab, m_SkillId,
