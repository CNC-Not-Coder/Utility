...
namespace Client.SkillTrigger
{
    ...
    internal class CharacterEffectTriger : AbstractSkillTriger
    {
        ...
        protected override void Load(FunctionData funcData)
        {
            ...
            if (null != callData)
            {
                ...
                ISyntaxComponent statement = funcData.Statements.Find(st => st.GetId() == "transform");
                if (null != statement)
                {
                    ...
                    if (null != stCall)
                    {
                        ...
                        {
                            CallData param0 = stCall.GetParam(0) as CallData;
                            if (null != param0)
                        ...
                        {
                            CallData param2 = stCall.GetParam(2) as CallData;
                            if (null != param2)
    ...
    internal class SceneEffectTriger : AbstractSkillTriger
    {
        ...
        protected override void Load(CallData callData)
        {
            ...
            if (num > 2)
            {
                m_Pos = ScriptableDataUtility.CalcVector3(callData.GetParam(2) as CallData);
            }
            if (num > 3)
            {
                m_StartTime = long.Parse(callData.GetParamId(3));
            ...
            if (num > 4)
            {
                m_Dir = ScriptableDataUtility.CalcEularRotation(callData.GetParam(4) as CallData);
            }
            if (num > 5)
            {
                m_Scale = ScriptableDataUtility.CalcVector3(callData.GetParam(5) as CallData);
            }
            if (num > 6)
            {
